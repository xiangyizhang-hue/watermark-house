  ...
  <Teleport to="body">
    <div v-if="modelValue" class="upd-mask" @click.self="close">
      <div class="upd-box">
        ...
        <div class="upd-list">
          <details class="upd-item">
            <summary>早期定制水印版记录（沿用原版 0.2.8 版本号）</summary>
            <p>创意水印初版：新增可编辑文字与单横线水印，按图片比例适配。</p>
            <p>2026-09-14 修复版：修复模板水印保存、空白导入与复位；新增上下品牌联动、文字快捷编辑和对齐修复。</p>
            <p>从 0.3.0 起，每次发布使用独立版本号。以下 0.2.8 及更早的版本记录属于原项目历史。</p>
          </details>
          <section
            v-for="e in entries"
            :key="e.version"
