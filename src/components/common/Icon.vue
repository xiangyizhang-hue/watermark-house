...
<template>
  <svg viewBox="0 0 16 16" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <g v-else-if="name === 'adjust'">
      <path d="M3 2v12M8 2v12M13 2v12" />
      <path d="M1 5h4M6 11h4M11 6h4" stroke-width="3" />
    </g>
    ...
    <!-- mobile navigation / editing actions -->
    ...
    <g v-else-if="name === 'undo'">
      ...
      <path d="M3.5 7.5H9a4 4 0 0 1 4 4" />
    </g>
    <g v-else-if="name === 'redo'">
      <path d="M9.5 4L13 7.5 9.5 11" />
      <path d="M12.5 7.5H7a4 4 0 0 0-4 4" />
    </g>
    ...
    <g v-else-if="name === 'settings'">
      ...
      <path d="M8 2.3v1.3M8 12.4v1.3M2.3 8h1.3M12.4 8h1.3M4 4l.9.9M11.1 11.1l.9.9M12 4l-.9.9M4.9 11.1L4 12" />
    </g>
    <g v-else-if="name === 'close'">
      <path d="M4 4l8 8M12 4l-8 8" />
    </g>
    <g v-else-if="name === 'save'">
      <path d="M3 2.5h8.7L13.5 4v9.5H3z" />
      <path d="M5 2.5v4h5v-4M5 13.5v-3.2h6v3.2" />
    </g>
  </svg>
</template>
